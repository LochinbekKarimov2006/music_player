...
//           )}
//           <div>
//             <p className="text-[17px] font-[700]">{currentTrack?.track?.name || "Play It Safe"}</p>
...
//       {isModalOpen && (
//         <div className="w-[250px] py-2 h-auto fixed bottom-[65px] flex flex-col items-end">
//           <button onClick={() => setIsModalOpen(false)} className="w-10 mb-[-40px] z-10">
//           <svg
//                 width="42"
//                 height="42"
//                 viewBox="0 0 32 32"
